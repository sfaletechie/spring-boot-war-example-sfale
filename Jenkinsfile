pipeline{
    ...
    stages{
        ...
        stage("artifactsUpload"){
            steps{
                nexusArtifactUploader artifacts: [[artifactId: 'hello-world', classifier: '', file: 'target/hello-world-0.0.1-SNAPSHOT.war', type: 'war']], credentialsId: 'adminnexus', groupId: 'com.springhow.example', nexusUrl: '192.168.29.42:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'simpleapp-release', version: '0.0.1-SNAPSHOT'
            }
        }   
        stage("deployOnTest"){
            steps{
